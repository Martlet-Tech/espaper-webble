...
int YMS800480_073AAX_E6_fill_index(uint8_t *buff)
{
	...
	uint8_t *data_buff = heap_caps_malloc(192000, MALLOC_CAP_SPIRAM);
	if (data_buff == NULL) {
	...
	build_data_e6(0, 0, 800, 480, index_buffer, epd_ram);
...
int YMS800480_073AAX_E6_update(void)
{
